...
public class Restaurant {
    ...
    public static Restaurant r3 = new Restaurant(2,"Bread Story",
    ...
    public static Restaurant r4 = new Restaurant(2,"BROWN",
    ...
    public static Restaurant r5 = new Restaurant(2,"Chop Chop",
            new RestType[]{RestType.Restaurant},
